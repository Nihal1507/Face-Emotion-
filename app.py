...
def main():
    ...
    <h2 style="color:white;text-align:center;">Haar Cascade Object Detection</h2>
        ...
        st.write('''
                  Email:- nihalahmed1507@gmail.com.
                  Linkedin:-https://www.linkedin.com/in/nihal-ahmed-nxtwave/
		  Email:- @gmail.com.
    ...
    <h2 style="color:white;text-align:center;">Copyright © 2024 | Nihal Ahmed , Rizwan </h2>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
